...
namespace River.OneMoreAddIn.Models
{
	...
	/// </summary>
	internal partial class PageRob
	{
		...
		public PageRob(XElement root)
		{
			if (root != null)
			{
				...
				CreatedDateTime = root.Attribute("dateTime")?.Value;
				ModifiedDateTime = root.Attribute("lastModifiedTime")?.Value;
			}
		...
		/// <summary>
		/// Set the page creation date and time.
		/// </summary>
		/// <param name="dateTime">Must be in the format 2022-01-01T01:02:03.000Z</param>
		public void SetCreatedDateTime(string dateTime)
		{
			Root.Attribute("dateTime").Value = dateTime;
		}

		/// <summary>
		/// Set the page modification date and time.
		/// </summary>
		/// <param name="dateTime">Must be in the format 2022-01-01T01:02:03.000Z</param>
		public void SetModifiedDateTime(string dateTime)
		{
			Root.Attribute("lastModifiedTime").Value = dateTime;
		}
		...
		public string ModifiedDateTime { get; private set; }
